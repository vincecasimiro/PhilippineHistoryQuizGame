...
public class QuizHelperPHHistoryMysteryRound extends SQLiteOpenHelper {
    private static final int DATABASE_VERSION = 1;
    // Database Name
    private static final String DATABASE_NAME = "PHHistoryMysteryRound";
    // tasks table name
    ...
    public QuizHelperPHHistoryMysteryRound(Context context) {
...
// db.close();
    ...
    private void addQuestion() {
        Question q1 = new Question("Who is the first Chief Justice who was removed from office by an impeachment case?", "Cayetano Arellano", "Renato Corona", "Ma. Lourdes Sereno",
