...
public class QuizHelperFITBAverage extends SQLiteOpenHelper {
    private static final int DATABASE_VERSION = 1;
    // Database Name
    private static final String DATABASE_NAME = "FITBAverage";
    // tasks table name
    ...
    public QuizHelperFITBAverage(Context context) {
...
// db.close();
    ...
    private void addQuestion() {
        Question q1 = new Question("__________ secretly established the Katipunan in 1892.", "Emilio Jacinto", "Marcelo H. Del Pilar", "Andres Bonifacio",
                "Andres Bonifacio"); //Answer: C
        this.addQuestion(q1);
        Question q2 = new Question("Rizal was executed in ______.", "Malate", "Bagumbayan", "Pandacan",
                "Bagumbayan"); //Answer: B
        this.addQuestion(q2);
