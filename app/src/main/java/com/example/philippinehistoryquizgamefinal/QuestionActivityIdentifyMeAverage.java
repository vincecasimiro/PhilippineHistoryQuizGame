...
public class QuestionActivityIdentifyMeAverage extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_identify_me_average);
        ...
        QuizHelperIdentifyMeAverage db = new QuizHelperIdentifyMeAverage(this); // my question bank class
