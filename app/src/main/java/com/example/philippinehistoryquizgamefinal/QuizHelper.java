...
public class QuizHelper extends SQLiteOpenHelper {
    ...
    // Database Name
    private static final String DATABASE_NAME = "QuizBeeEasy";
    // tasks table name
...
// db.close();
    ...
    private void addQuestion() {
        Question q1 = new Question("She was given the title Mother of Biak-na-Bato by Gen. Aguinaldo.", "Gregoria de Jesus", "Trinidad Tecson", "Gabriela Silang",
                "Trinidad Tecson"); //Answer: B
        this.addQuestion(q1);
        Question q2 = new Question("What is the primary goal of the Katipunan?", "To assert dominance from Spain", "To give the Filipinos some confidence", "To gain independence from Spain through a revolution",
                "To gain independence from Spain through a revolution"); //Answer:C
        this.addQuestion(q2);
